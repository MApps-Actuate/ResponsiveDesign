$(document).ready(function() {
    ...
    var rptDesign = 'Applications/Responsive Design/Report Designs/San Francisco Crime Statistics 2014.rptdesign';
    var reqOps    = new actuate.RequestOptions();
    var viewer;
    var paramsDownloaded = false;

    var bookmarks = ['arrestPie',
                     'NightDayPie',
                     'TopCrimesBar',
                     'TotalCrimesByDayOfWeek',
                     'CrimeByMonth',
					 'CrimesByDistrict'];

    actuate.initialize( iHub, reqOps==undefined?null:reqOps, 'administrator', null, myInit);
    ...
    function myInit()  {
        try {
            ...
            viewer = [new actuate.Viewer('viewerContainer0'),
					  ...
					  new actuate.Viewer('viewerContainer5')];
